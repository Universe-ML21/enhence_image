...
def resnet(input_image):
    ...
    with tf.compat.v1.variable_scope("generator"):
        ...
        enhanced1 = tf.nn.tanh(conv2d(c11, W12) + b12) * 0.58 + 0.5
...
def toImage(strImg):
    global high, width, IMAGE_WIDTH, IMAGE_HEIGHT, IMAGE_SIZE, check, enhanced, saver
    ...
    print("type of enhanced = ", str(type(enhanced)))

    saver = tf.compat.v1.train.Saver()
    save_path = "models_orig/" + str(phone)
    print(save_path)
