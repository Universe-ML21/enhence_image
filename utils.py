...
def process_test_model_args(arguments):
    ...
    print("phone =", str(phone), str(" dped_dir ="), str(dped_dir), str(" test_subset ="), str(test_subset),
          str(" iteration ="), str(iteration), str(" resolution"), str(resolution), str(" use_gpu"), str(use_gpu))
...
def get_resolutions():
    ...
    res_sizes = {"iphone": [1536, 2048], "iphone_orig": [1536, 2048], "blackberry": [1560, 2080],
                 "blackberry_orig": [1560, 2080], "sony": [1944, 2592], "sony_orig": [1944, 2592], "high": [1260, 1680],
                 "medium": [1024, 1366], "small": [768, 1024], "tiny": [600, 800]}
